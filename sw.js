...
const CACHE_NAME = 'zenresume-cache-v2.0';
const STATIC_SHELL = [
  '/',
  '/index.html',
  '/styles.css?v=2.0',
  '/adaptive-engine.js?v=2.0',
  '/app.js?v=2.0',
  '/templates-data.js?v=2.0',
  '/firebase-service.js?v=2.0',
  '/role-hub.js?v=2.0',
  '/live-pulse.js?v=2.0',
  '/ats-matcher.js?v=2.0',
  '/payment-mediator.js?v=2.0',
  '/manifest.json',
  '/favicon-96x96.png',
