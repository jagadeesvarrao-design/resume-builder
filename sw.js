...
const CACHE_NAME = 'zenresume-cache-v2.6';
const STATIC_SHELL = [
  '/',
  '/index.html',
  '/styles.css?v=2.6',
  '/adaptive-engine.js?v=2.6',
  '/app.js?v=2.6',
  '/templates-data.js?v=2.6',
  '/firebase-service.js?v=2.6',
  '/role-hub.js?v=2.6',
  '/live-pulse.js?v=2.6',
  '/ats-matcher.js?v=2.6',
  '/payment-mediator.js?v=2.6',
  '/manifest.json',
  '/favicon-96x96.png',
