...
const CACHE_NAME = 'zenresume-cache-v2.7';
const STATIC_SHELL = [
  '/',
  '/index.html',
  '/styles.css?v=2.7',
  '/adaptive-engine.js?v=2.7',
  '/app.js?v=2.7',
  '/templates-data.js?v=2.7',
  '/firebase-service.js?v=2.7',
  '/role-hub.js?v=2.7',
  '/live-pulse.js?v=2.7',
  '/ats-matcher.js?v=2.7',
  '/payment-mediator.js?v=2.7',
  '/manifest.json',
  '/favicon-96x96.png',
