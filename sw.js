/**
 * ZenResume Offline Service Worker (PWA Engine) - v8.11
...
const CACHE_NAME = 'zenresume-cache-v8.11';
const STATIC_SHELL = [
  '/',
  '/index.html',
  '/styles.css?v=8.11',
  '/adaptive-engine.js?v=8.11',
  '/app.js?v=8.11',
  '/templates-data.js?v=8.11',
  '/firebase-service.js?v=8.11',
  '/role-hub.js?v=8.11',
  '/live-pulse.js?v=8.11',
  '/ats-matcher.js?v=8.11',
  '/payment-mediator.js?v=8.11',
  '/manifest.json',
  '/favicon-96x96.png',
