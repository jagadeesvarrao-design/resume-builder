...
const CACHE_NAME = 'zenresume-cache-v2.9';
const STATIC_SHELL = [
  '/',
  '/index.html',
  '/styles.css?v=2.9',
  '/adaptive-engine.js?v=2.9',
  '/app.js?v=2.9',
  '/templates-data.js?v=2.9',
  '/firebase-service.js?v=2.9',
  '/role-hub.js?v=2.9',
  '/live-pulse.js?v=2.9',
  '/ats-matcher.js?v=2.9',
  '/payment-mediator.js?v=2.9',
  '/manifest.json',
  '/favicon-96x96.png',
